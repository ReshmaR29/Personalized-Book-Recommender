...
# import data
books = pd.read_csv('Data/Books.csv', low_memory=False)  # books data
users = pd.read_csv('Data/Users.csv', low_memory=False) # Users location and age data
ratings = pd.read_csv('Data/Ratings.csv', low_memory=False) # Users rating data
